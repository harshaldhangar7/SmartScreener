...
def extract_education(text):
    """Extract education information from the text with improved degree/field parsing."""
    education = []
    ...
    # Find degrees
    degree_patterns = [
        r'\b(?:Ph\.?D\.?|Doctor of Philosophy|Doctorate|Doctoral)\b',
        r'\b(?:M\.?S\.?|MSc|M\.Sc\.|Master of Science|Master\'s|MBA|MCA|MTech|M\.Tech|ME|M\.E)\b',
        r'\b(?:B\.?S\.?|BSc|B\.Sc\.|Bachelor of Science|Bachelor\'s|BCA|BTech|B\.Tech|BE|B\.E|B\.A\.|BA|Bachelor of Arts)\b',
        r'\b(?:Associate|Diploma|Certificate|High School|HSC|SSC)\b'
    ]
    ...
    for pattern in degree_patterns:
        ...
        for match in matches:
            ...
            # Try to detect field of study near the degree
            field_match = re.search(r'in\s+([A-Za-z][A-Za-z &/\-]+)', context)
